...
export const profile = {
  ...
  bio: [
    ...
    "Rymden är en av mina största passioner och en av anledningarna till att den här sidan finns. Målet är att kombinera min bakgrund inom mjukvaruteknik med mitt intresse för rymdfart och landa en praktikplats hos ett rymd- eller satellitbolag under min tredje termin på civilingenjörsprogrammet.",
  ],
